...
This project uses a **Convolutional Neural Network (CNN)** to detect potato leaf diseases from images.
It helps farmers identify plant diseases early and take preventive action.
...
* Optimized using data augmentation
